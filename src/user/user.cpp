...
int main() {
    ...
    std::vector<address> pod_addresses = {
            {"10.10.1.1", "a0:36:9f:85:81:80", {0xa0, 0x36, 0x9f, 0x85, 0x81, 0x80}},
            {"10.10.1.2", "a0:36:9f:85:7e:d0", {0xa0, 0x36, 0x9f, 0x85, 0x7e, 0xd0}},
            {"10.10.1.3", "a0:36:9f:85:7f:94", {0xa0, 0x36, 0x9f, 0x85, 0x7f, 0x94}}
    };
